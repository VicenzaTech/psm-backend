...
export class StageAssignmentController {
    constructor(private readonly stageAssignmentService: StageAssignmentService) { }
    @Get()
    async findAll(
        ...
        return this.stageAssignmentService.findAll({
            productionPlanId:
                typeof planId === 'number' && !Number.isNaN(planId) ? planId : undefined,
            productionLineId:
                typeof lineId === 'number' && !Number.isNaN(lineId) ? lineId : undefined,
        });
    }

    @Get(':id')
    async findOne(@Param('id', ParseIntPipe) id: number) {
        return this.stageAssignmentService.findOne(id);
    }
    ...
    async create(
        ...
        return this.stageAssignmentService.create({
    ...
    async update(
        ...
        return this.stageAssignmentService.update(id, body);
    }

    @Delete(':id')
    async disable(@Param('id', ParseIntPipe) id: number) {
        return this.stageAssignmentService.disable(id);
    }
}
